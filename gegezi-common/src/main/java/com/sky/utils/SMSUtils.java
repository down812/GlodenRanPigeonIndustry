...
import com.sky.properties.SMSProperty;
...
public class SMSUtils {
    ...
    public static void sendMessage(String signName, String templateCode,String phoneNumbers,String param){
        DefaultProfile profile = DefaultProfile.getProfile(smsProperty.getRegionId(), smsProperty.getAppKey(), smsProperty.getAppSecret());
